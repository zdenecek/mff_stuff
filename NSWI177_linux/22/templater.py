...
class StoreValueAction(argparse.Action):
    ...
    def __call__(self, parser, namespace, values, option_string=None):
        ...
        setattr(namespace, *values.split("=", maxsplit=1))
        # TODO: Remove unsafe  delattr: Is there a way to prevent default setting of V?
        delattr(namespace, "V")
...
def jinja_filter_arabic2roman(text):
    try:
        ...
        print_e("Invalid conversion to roman")
        return "NaN"
