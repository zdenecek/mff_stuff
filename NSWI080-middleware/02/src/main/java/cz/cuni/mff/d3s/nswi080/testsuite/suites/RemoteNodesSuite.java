...
public class RemoteNodesSuite implements TestSuite {
    private final String rmiUrl;

    public RemoteNodesSuite(String rmiUrl) {
        this.rmiUrl = rmiUrl;
    }

     @Override
    public Graph createGraph(int nodeCount, int edgeCount, Random random) throws RemoteException {
