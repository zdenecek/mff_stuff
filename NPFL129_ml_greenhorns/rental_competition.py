...
def create_pipeline():
    ...
    categorical_features = [
        Features.SEASON.value,
        Features.MONTH.value,
        Features.DAY.value,
        Features.HOUR.value,
        Features.HOLIDAY.value,
        Features.WORKING_DAY.value,
    ...
    numerical_features = [
        ...
        Features.FEELING.value,
        Features.RELATIVE.value,
    ...
    # Define the model with cross-validated Ridge regression
